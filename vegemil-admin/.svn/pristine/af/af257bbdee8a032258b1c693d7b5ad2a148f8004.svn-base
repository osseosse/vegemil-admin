...
$(function () {
  ...
  if (dt_basic_table.length) {
    var dt_basic = dt_basic_table.DataTable({
      ...
      columnDefs: [
		...
		},
		{
			...
			render: function (data, type, full, meta) {
      			return(
      				'<a href="/admin/cs/cpPdsDownload?fileName=' + full['pFname'] + '" target="_blank">' + full['pFname'] + '</a>'
      			);
		...
		},
		{
      	...
      	},
  		{
			...
			render: function (data, type, full, meta) {
				return(
					'<a href="/admin/cs/cpPdsDelete?pIdx=' + full['pIdx'] + '">' + 
    ...
    $('div.head-label').html('<h6 class="mb-0">CP 자료실</h6>');
