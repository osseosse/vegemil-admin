...
$(function () {
  ...
  if (dt_basic_table.length) {
    var dt_basic = dt_basic_table.DataTable({
      ...
      columnDefs: [
		...
		},
		{
			...
			render: function (data, type, full, meta) {
				return(
					'<a href="/admin/lab/faqDetail?fIdx=' + full['fIdx'] + '">' +
					full['fQuestion'] + 
					'</a>'
      			);
      		}
      	...
      	},
		{
			...
			render: function (data, type, full, meta) {
				return(
					'<a href="/admin/cs/unfairClaimDelete?cIdx=' + full['fIdx'] + '">' + 
    ...
    $('div.head-label').html('<h6 class="mb-0">FAQ 리스트</h6>');
